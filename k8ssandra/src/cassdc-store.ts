...
export class CassandraDatacenterApi extends Renderer.K8sApi
  .KubeApi<CassandraDatacenter> {}

export class CassandraDatacenterStore extends Renderer.K8sApi
  .KubeObjectStore<CassandraDatacenter> {
