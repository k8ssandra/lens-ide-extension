...
export class K8ssandraClusterApi extends Renderer.K8sApi
  .KubeApi<K8ssandraCluster> {}

export class K8ssandraClusterStore extends Renderer.K8sApi
  .KubeObjectStore<K8ssandraCluster> {
